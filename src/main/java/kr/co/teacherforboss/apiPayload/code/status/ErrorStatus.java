...
public enum ErrorStatus implements BaseErrorCode {
    ...
    INVALID_QUESTION_CATEGORY(BAD_REQUEST, "BOARD4004", "유효한 카테고리 식별자를 기입해주세요."),
    INVALID_EXTRA_CONTENT_FIELDS(BAD_REQUEST, "BOARD4005", "카테고리에 해당되지 않는 질문 필드입니다."),
    INVALID_QUESTION_USER_TYPE(BAD_REQUEST, "BOARD4006", "카테고리에 해당되지 않는 사용자 유형값입니다."),
